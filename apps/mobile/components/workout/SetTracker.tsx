          ...
          return (
            ...
            >
              <View
                style={[
                  styles.statusIcon,
                  { backgroundColor: statusColor, borderRadius: radii.xl },
                ]}
              >
              ...
              {set.status === 'completed' && set.actualReps !== undefined && (
                <Text
                  style={{ color: status.success, fontSize: typography.size.xs, fontWeight: '600' }}
                >
              ...
              {isCurrent && (
                <View style={styles.actionBtns}>
                  <Pressable
                    ...
                    style={[
                      styles.smallBtn,
                      { backgroundColor: status.success, borderRadius: radii.sm },
                    ]}
