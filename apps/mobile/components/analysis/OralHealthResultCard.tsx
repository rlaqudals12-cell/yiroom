  ...
  return (
    ...
    >
      ...
      <View
        style={[
          styles.header,
          { backgroundColor: `${module.oralHealth.base}15`, padding: spacing.md },
        ]}
      >
        ...
        {[
          ...
          <Pressable
            ...
            style={[
              styles.tab,
              activeTab === tab.key && {
                borderBottomColor: module.oralHealth.base,
                borderBottomWidth: 2,
              },
            ]}
          >
              ...
              <View>
                ...
                {whiteningGoal.methods.map((method, index) => {
                  ...
                  return (
                    ...
                    >
                      <Text
                        style={{ color: colors.foreground, fontSize: typography.size.sm, flex: 1 }}
                      >
                        {method.name}
                      </Text>
                      <Text
                        style={{
                          color: status[eff?.colorKey ?? 'info'],
                          fontSize: typography.size.xs,
                          fontWeight: '500',
                        }}
                      >
