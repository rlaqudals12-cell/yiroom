/**
 * 배색(Color Harmony) 알고리즘 — 웹 lib/color/harmony.ts 포팅 (ADR-105)
 *
 ...
 * @see lib/color/index.ts (hexToLab, labToRgb, rgbToHex, calculateChroma, calculateHue 재사용)
 */

import type { LabColor } from './index';
import { hexToLab, labToRgb, rgbToHex, calculateChroma, calculateHue } from './index';
