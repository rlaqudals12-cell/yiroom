 ...
 * 임상적 의미:
 * - deltaE < 1.0: 인지 불가
 * - deltaE 1.0-2.7: 인지 가능, 허용 범위
 * - deltaE 2.7-3.3: 허용 경계
 * - deltaE > 3.3: 임상적으로 허용 불가
 */
...
export type ColorDifferenceInterpretation =
  | 'imperceptible' // deltaE < 1.0
  | 'perceptible' // deltaE 1.0-2.7
  | 'threshold' // deltaE 2.7-3.3
  | 'clinically_unacceptable'; // deltaE > 3.3
