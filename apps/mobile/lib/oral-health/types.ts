/**
 * OH-1 구강건강 분석 타입 정의 (모바일)
 *
 * 웹 types/oral-health.ts를 모바일 환경에 맞춰 인라인 정의.
 * 색공간 타입은 @/lib/color에서 re-export.
 *
...
// =============================================================================
// Gemini 응답 타입 (API 브릿지에서 사용)
// =============================================================================

/**
 * Gemini 구강건강 분석 응답 타입
 *
 * 웹에서는 Zod 스키마에서 추론되지만,
 * 모바일에서는 API 응답 변환용으로 인터페이스로 정의.
 */
export interface GeminiOralHealthResponse {
  canAnalyze: boolean;
  confidence: number;
  toothColor: {
