...
export const ENCOURAGEMENT_MESSAGES: MessageTemplate[] = [
  // 스트릭 격려
  {
    type: 'encouragement',
    title: '연속 기록 유지 중!',
    body: '오늘도 이어가고 있어요. 멋져요! 🔥',
    icon: '🔥',
  },
  {
    type: 'encouragement',
    title: '꾸준함이 힘이에요',
    body: '매일 조금씩, 큰 변화를 만들어가고 있어요',
    icon: '💪',
  },
  {
    type: 'encouragement',
    title: '오늘의 한 걸음',
    body: '작은 노력이 모여 큰 결과를 만들어요',
    icon: '👣',
  },
  ...
  // 운동 격려
  {
    type: 'encouragement',
    title: '운동 시작이 반!',
    body: '오늘 운동 계획을 세워볼까요?',
    icon: '🏋️',
  },
  {
    type: 'encouragement',
    title: '몸이 기억해요',
    body: '꾸준한 운동이 체형을 바꿔요',
    icon: '💪',
  },
  ...
  // 영양 격려
  {
    type: 'encouragement',
    title: '균형 잡힌 하루',
    body: '오늘 식단을 기록하면 영양 밸런스를 확인할 수 있어요',
    icon: '🥗',
  },
  {
    type: 'encouragement',
    title: '물 한 잔 어때요?',
    body: '수분 섭취는 피부 건강의 기본이에요',
    icon: '💧',
  },
  ...
  // 뷰티 격려
  {
    type: 'encouragement',
    title: '피부 관리 시간',
    body: '오늘의 스킨케어 루틴을 완료해보세요',
    icon: '✨',
  },
  {
    type: 'encouragement',
    title: '변화를 느껴보세요',
    body: '정기적인 분석으로 변화를 추적해요',
    icon: '📊',
  },
  ...
  // 일반 격려
  {
    type: 'encouragement',
    title: '당신은 잘하고 있어요',
    body: '꾸준히 자기 관리를 하는 것 자체가 대단해요',
    icon: '🌟',
  },
  {
    type: 'encouragement',
    title: '오늘도 빛나는 하루',
    body: '이룸과 함께 더 나은 나를 만들어가요',
    icon: '✨',
  },
];
...
export const TIP_MESSAGES: MessageTemplate[] = [
  {
    type: 'tip',
    title: '스킨케어 팁',
    body: '세안 후 3분 이내에 토너를 발라야 수분이 유지돼요',
    icon: '💡',
  },
  {
    type: 'tip',
    title: '운동 팁',
    body: '공복 운동보다 가벼운 간식 후 운동이 효과적이에요',
    icon: '💡',
  },
  {
    type: 'tip',
    title: '영양 팁',
    body: '단백질은 한 끼에 20-30g이 최적 흡수량이에요',
    icon: '💡',
  },
  { type: 'tip', title: '수면 팁', body: '7-8시간 수면이 피부 재생에 가장 좋아요', icon: '💡' },
  {
    type: 'tip',
    title: '자세 팁',
    body: '1시간마다 스트레칭을 하면 자세 개선에 도움돼요',
    icon: '💡',
  },
  {
    type: 'tip',
    title: '퍼스널컬러 팁',
    body: '자연광에서 촬영하면 더 정확한 분석이 가능해요',
    icon: '💡',
  },
];
