...
const MINDFULNESS_TIPS = [
  {
    emoji: '🧘',
    title: '심호흡',
    description: '4초 들이쉬고, 7초 참고, 8초 내쉬세요',
    duration: '3분',
  },
  {
    emoji: '🌿',
    title: '그라운딩',
    description: '주변에서 5가지 보이는 것을 찾아보세요',
    duration: '5분',
  },
  {
    emoji: '📝',
  ...
  },
  {
    emoji: '🎵',
    title: '음악 명상',
    description: '좋아하는 음악을 들으며 눈을 감아보세요',
    duration: '10분',
  },
];
        ...
        {MINDFULNESS_TIPS.map((tip, index) => (
          <Animated.View key={tip.title} entering={staggeredEntry(index)}>
            ...
            >
              ...
              >
                <Text style={{ fontSize: typography.size.xs, color: brand.primary }}>
                  {tip.duration}
                </Text>
              </View>
            </Pressable>
      ...
      <View style={{ gap: spacing.xs }}>
        {MOCK_MOOD_HISTORY.map((entry, index) => {
          ...
          return (
            ...
            >
              <Text style={{ fontSize: typography.size['2xl'], marginRight: spacing.sm }}>
                {moodOption?.emoji}
              </Text>
              <View style={{ flex: 1 }}>
                <Text
