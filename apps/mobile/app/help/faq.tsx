...
const FAQ_DATA: FAQItem[] = [
  {
    ...
    answer:
      '사진을 업로드하면 AI가 피부, 체형, 퍼스널컬러 등을 분석해요. Google Gemini AI를 활용하여 정밀한 분석 결과를 제공합니다.',
    category: '분석',
  },
  {
    id: '2',
    ...
    answer:
      'AI 분석은 참고용이며 전문가 진단을 대체하지 않아요. 조명, 카메라 각도 등에 따라 결과가 달라질 수 있어요. 자연광에서 정면 촬영하면 더 정확한 결과를 얻을 수 있어요.',
    category: '분석',
  },
  {
    id: '3',
    ...
    answer:
      '모든 사진은 분석 후 서버에서 즉시 삭제돼요. 개인 정보는 암호화되어 저장되며, 제3자에게 공유되지 않아요.',
    category: '개인정보',
  },
  {
    id: '4',
    ...
    answer:
      '기본 분석 기능은 무료로 제공돼요. 일일 분석 횟수 제한이 있을 수 있으며, 향후 프리미엄 기능이 추가될 수 있어요.',
    category: '요금',
  },
  {
    id: '5',
    ...
    answer:
      '운동 탭에서 운동 종류를 선택하고 시간을 입력하면 칼로리 소모량이 자동 계산돼요. MET 기반 과학적 공식을 사용해요.',
    category: '운동',
  },
  {
    id: '6',
    ...
    answer:
      '영양 탭에서 음식 사진을 찍거나 검색하여 기록할 수 있어요. AI가 음식을 인식하고 칼로리와 영양소를 자동으로 계산해줘요.',
    category: '영양',
  },
  {
    id: '7',
    ...
    answer:
      '퍼스널컬러는 개인의 피부톤, 눈동자색, 머리카락 색상 등을 종합적으로 분석하여 가장 잘 어울리는 색상 팔레트를 찾아주는 시스템이에요. 봄, 여름, 가을, 겨울 4계절로 나뉘어요.',
    category: '분석',
  },
  {
    id: '8',
    ...
    answer:
      '프로필 > 설정 > 계정 삭제에서 계정을 삭제할 수 있어요. 삭제 시 모든 데이터가 영구적으로 삭제되며 복구할 수 없어요.',
    category: '계정',
  },
];
