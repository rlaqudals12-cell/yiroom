...
const STYLE_OPTIONS: { id: StylePreference; label: string; emoji: string; description: string }[] =
  [
    ...
    { id: 'street', label: '스트릿', emoji: '🧢', description: '트렌디하고 개성 있는 스타일' },
    {
      ...
      label: '클래식',
      emoji: '👔',
      description: '시간이 지나도 변하지 않는 스타일',
    },
...
export default function StyleProfileScreen(): React.ReactElement {
  ...
  return (
    <ScreenContainer testID="style-profile-screen" backgroundGradient="style" contentPadding={0}>
      {/* 제목 */}
      <Animated.View
        entering={FadeInUp.delay(0).duration(TIMING.normal)}
        style={{ paddingHorizontal: spacing.lg, paddingTop: spacing.lg, marginBottom: spacing.xl }}
      >
        <Text
          style={{
              ...
              return (
                <Pressable
                  ...
                  style={{
                    ...
                    backgroundColor: selected ? brand.primary + '15' : colors.secondary,
                    borderWidth: 2,
