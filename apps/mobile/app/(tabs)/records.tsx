...
import { useTheme, spacing, radii, ICON_BG_OPACITY, borderGlow } from '../../lib/theme';
...
export default function RecordsTab(): React.JSX.Element {
  ...
  const workoutWeek = useMemo(() => buildWorkoutWeek(weeklyLogs), [weeklyLogs]);
  ...
  return (
    ...
    >
      ...
      <Animated.View entering={FadeInUp.delay(100).duration(TIMING.normal)}>
        ...
        {!isLoading && (
          <View
            accessibilityLabel={`칼로리 진행률 ${calorieProgress}%, ${todaySummary?.totalCalories || 0}kcal / ${calorieGoal}kcal`}
          >
            <GradientProgressBar
        ...
        >
          ...
          >
            <View style={styles.waterLeft}>
              <View
                style={[styles.iconCircle, { backgroundColor: moduleColors.skin.light + '40' }]}
              >
      ...
      <Animated.View entering={FadeInUp.delay(250).duration(TIMING.normal)}>
        ...
        {isLoading ? (
          ...
          <>
            ...
            >
              <WorkoutWeekHeatmap days={workoutWeek} testID="workout-heatmap" />
            </CollapsibleSection>
