        ...
        <View style={styles.langToggle}>
          <TouchableOpacity
            style={[
              ...
              {
                backgroundColor:
                  lang === 'ko' ? brandColors.primary : colors.muted,
          ...
          <TouchableOpacity
            style={[
              ...
              {
                backgroundColor:
                  lang === 'en' ? brandColors.primary : colors.muted,
                borderRadius: radii.lg,
              },
            ]}
            onPress={() => setLang('en')}
    ...
    <View>
      ...
      <View style={styles.section}>
        ...
        <BulletItem colors={colors}>
          회원 가입 및 관리: 회원 가입의사 확인, 회원제 서비스 제공에 따른 본인
          식별·인증
        </BulletItem>
        <BulletItem colors={colors}>
          서비스 제공: 퍼스널 컬러 진단, 피부 분석, 체형 분석, 운동/영양 관리
          서비스 제공
        </BulletItem>
        <BulletItem colors={colors}>
      ...
      <View style={styles.section}>
        ...
        <BulletItem colors={colors}>
          선택 항목: 프로필 사진, 키, 체중, 생년월일, 성별
        </BulletItem>
        <BulletItem colors={colors}>
          서비스 이용 시 수집: 얼굴/체형 이미지, 운동 기록, 식단 기록, AI 코치
          대화 내용
        </BulletItem>
        <BulletItem colors={colors}>
      ...
      <View style={styles.section}>
        ...
        <BulletItem colors={colors}>
          분석 이미지: 별도 동의 시 동의일로부터 1년간 보관, 미동의 시 분석 완료
          후 즉시 삭제
        </BulletItem>
        <BulletItem colors={colors}>
          AI 코치 대화: 세션 종료 시 삭제 (대화 내용은 서버에 영구 저장하지
          않음)
        </BulletItem>
        <BulletItem colors={colors}>
      ...
      <View style={styles.section}>
        ...
        <Paragraph colors={colors}>
          회사는 개인정보보호법 제23조에 따라 사용자의 얼굴, 체형 등 생체정보를
          수집·이용하는 경우 별도의 동의를 받습니다.
        </Paragraph>
        <BulletItem colors={colors}>
          수집 항목: 피부 분석용 얼굴 이미지, 체형 분석용 전신 이미지, 퍼스널
          컬러 분석용 이미지
        </BulletItem>
        <BulletItem colors={colors}>
        ...
        <BulletItem colors={colors}>
          보유 기간: 동의 시 1년, 동의 철회 시 즉시 삭제
        </BulletItem>
        <BulletItem colors={colors}>
          동의 방법: 분석 기능 사용 시 별도 동의 화면 제공
        </BulletItem>
        <BulletItem colors={colors}>
        ...
        <View style={[styles.warningBox, isDark && styles.warningBoxDark]}>
          <Text style={[styles.warningText, isDark && styles.warningTextDark]}>
            안내: 이미지 저장에 동의하지 않아도 분석 서비스는 이용 가능합니다.
            다만 이전 분석 결과와의 비교(변화 추적) 기능은 사용할 수 없습니다.
          </Text>
        </View>
      </View>
      ...
      <View style={styles.section}>
        ...
        <Paragraph colors={colors}>
          회사는 원칙적으로 정보주체의 개인정보를 수집·이용 목적으로 명시한 범위
          내에서 처리하며, 다음의 경우를 제외하고는 정보주체의 사전 동의 없이
        ...
        <InfoBox colors={colors}>
          ...
          <Text style={[styles.infoText, { color: colors.cardForeground }]}>
            이룸의 AI 분석 기능(퍼스널컬러, 피부, 체형 등)은 Google Gemini API를
            활용합니다. 분석 시 사용자의 이미지 데이터가 Google의 AI 서버로
            전송되어 처리됩니다.
          </Text>
          <TouchableOpacity
            onPress={() =>
              Linking.openURL('https://ai.google.dev/gemini-api/terms')
            }
          >
        ...
        <InfoBox colors={colors}>
          ...
          <Text style={[styles.infoText, { color: colors.cardForeground }]}>
            서비스 내 제품 추천 링크를 통해 외부 쇼핑몰(쿠팡 등)로 이동하는
            경우, 해당 외부 서비스의 개인정보처리방침이 적용됩니다. 이룸은 제휴
            링크 클릭 여부만 익명으로 집계하며, 외부 서비스에서의 구매 정보는
            수집하지 않습니다.
          </Text>
        </InfoBox>
      </View>
      ...
      <View style={styles.section}>
        ...
        <BulletItem colors={colors}>
          {'설정 > 계정 관리 > 회원 탈퇴를 통해 직접 삭제'}
        </BulletItem>
        <BulletItem colors={colors}>
          이메일(privacy@yiroom.app)로 삭제 요청
        </BulletItem>
        <BulletItem colors={colors}>
  ...
  return (
    <View>
      ...
      <View style={styles.section}>
        ...
        <Paragraph colors={colors}>
          Yiroom ("Company") processes personal data for the following purposes.
          Data collected will not be used beyond these stated purposes. If
          purposes change, we will obtain separate consent and take necessary
          measures.
        </Paragraph>
        <BulletItem colors={colors}>
          Membership management: identity verification and authentication for
          account registration
        </BulletItem>
        <BulletItem colors={colors}>
          Service delivery: personal color diagnosis, skin analysis, body type
          analysis, workout and nutrition management
        </BulletItem>
        <BulletItem colors={colors}>
        ...
        <BulletItem colors={colors}>
          Social features: friend connections, activity feeds, leaderboards, and
          challenges
        </BulletItem>
        <BulletItem colors={colors}>
          Product recommendations: personalized product suggestions based on
          analysis results and affiliate services
        </BulletItem>
        <BulletItem colors={colors}>
          Service improvement: analysis of usage records, service improvement,
      ...
      <View style={styles.section}>
        ...
        <Paragraph colors={colors}>
          The Company collects the following personal data to provide its
          services:
        </Paragraph>
        <BulletItem colors={colors}>
          Required: Email address, password, nickname
        </BulletItem>
        <BulletItem colors={colors}>
          Optional: Profile photo, height, weight, date of birth, gender
        </BulletItem>
        <BulletItem colors={colors}>
          Collected during service use: Face/body images, workout records, diet
        ...
        <BulletItem colors={colors}>
          Automatically collected: Service usage logs, access logs, device
      ...
      <View style={styles.section}>
        ...
        <Paragraph colors={colors}>
          The Company retains and processes personal data within the retention
          period required by applicable laws or as agreed upon during data
          collection.
        </Paragraph>
        <BulletItem colors={colors}>
          Account information: Until account deletion (destroyed within 30 days
          of deletion)
        </BulletItem>
        <BulletItem colors={colors}>
          Analysis images: Retained for 1 year with consent; immediately deleted
          after analysis if no consent given
        </BulletItem>
        <BulletItem colors={colors}>
          AI coach conversations: Deleted upon session end (conversations are
          not permanently stored on servers)
        </BulletItem>
        <BulletItem colors={colors}>
          Social activity records: Until account deletion (destroyed within 30
          days of deletion)
        </BulletItem>
      ...
      <View style={styles.section}>
        ...
        <Paragraph colors={colors}>
          In accordance with Article 23 of the Personal Information Protection
          Act (Korea), the Company obtains separate consent when collecting and
          using biometric data such as facial features and body shape.
        </Paragraph>
        <BulletItem colors={colors}>
          Data collected: Facial images for skin analysis, full-body images for
          body type analysis, images for personal color analysis
        </BulletItem>
        <BulletItem colors={colors}>
          Purpose: AI-powered skin, body type, and personal color analysis, and
          progress tracking
        </BulletItem>
        <BulletItem colors={colors}>
          Retention: 1 year with consent; immediately deleted upon consent
          withdrawal
        </BulletItem>
        <BulletItem colors={colors}>
          Consent method: Separate consent screen provided when using analysis
          features
        </BulletItem>
        <BulletItem colors={colors}>
        ...
        <View style={[styles.warningBox, isDark && styles.warningBoxDark]}>
          <Text style={[styles.warningText, isDark && styles.warningTextDark]}>
            Note: Analysis services are available even without consenting to
            image storage. However, comparison with previous results (progress
      ...
      <View style={styles.section}>
        <SectionTitle colors={colors}>
          5. Third-Party Data Sharing and AI Services
        </SectionTitle>
        <Paragraph colors={colors}>
          The Company does not share personal data with third parties beyond the
          stated purposes without prior consent, except in the following cases:
        </Paragraph>
        <BulletItem colors={colors}>
        ...
        <BulletItem colors={colors}>
          When necessary for the urgent protection of life, body, or property
          and the data subject is unable to express consent
        </BulletItem>
        <InfoBox colors={colors}>
          <Text style={[styles.infoTitle, { color: colors.cardForeground }]}>
          ...
          <Text style={[styles.infoText, { color: colors.cardForeground }]}>
            Yiroom's AI analysis features (personal color, skin, body type,
            etc.) utilize the Google Gemini API. When you use these features,
            your image data is transmitted to and processed by Google's AI
            servers.
          </Text>
          <TouchableOpacity
            onPress={() =>
        ...
        <InfoBox colors={colors}>
          ...
          <Text style={[styles.infoText, { color: colors.cardForeground }]}>
            When you click product recommendation links within the service, you
            will be redirected to external shopping platforms (e.g., Coupang).
            Their respective privacy policies apply. Yiroom only collects
            anonymized click statistics and does not collect any purchase
      ...
      <View style={styles.section}>
        ...
        <Paragraph colors={colors}>
          When personal data is no longer needed due to expiration of retention
          period or fulfillment of processing purpose, the Company destroys the
          data without delay.
        </Paragraph>
        <BulletItem colors={colors}>
      ...
      <View style={styles.section}>
        ...
        <BulletItem colors={colors}>
          Email request to privacy@yiroom.app
        </BulletItem>
        <BulletItem colors={colors}>
          Upon deletion, all personal data and analysis results are permanently
      ...
      <View style={styles.section}>
        ...
        <Paragraph colors={colors}>
          The Company has designated a Data Protection Officer to oversee all
          personal data processing and to address complaints and remedies
      ...
      <View style={styles.section}>
        ...
        <Paragraph colors={colors}>
          This Privacy Policy is effective as of February 20, 2026. Previous
