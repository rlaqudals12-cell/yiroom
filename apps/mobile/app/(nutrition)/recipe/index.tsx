...
export default function RecipeListScreen(): React.ReactElement {
  ...
  const { colors, spacing, radii, typography, module: moduleColors } = useTheme();
  ...
  return (
    <ScreenContainer testID="recipe-list-screen" edges={['bottom']} backgroundGradient="nutrition">
        ...
        {filteredRecipes.map((recipe, index) => (
          <Animated.View key={recipe.id} entering={staggeredEntry(index)}>
            <Pressable
              ...
              onPress={() =>
                router.push({
                  pathname: '/(nutrition)/recipe/[id]' as never,
                  params: { id: recipe.id },
                })
              }
              style={{
            ...
            >
              ...
              <View style={{ flexDirection: 'row', flexWrap: 'wrap', gap: spacing.xs }}>
                {recipe.tags.map((tag) => (
                  ...
                  >
                    <Text
                      style={{ fontSize: typography.size.xs, color: moduleColors.nutrition.base }}
                    >
                      {tag}
                    </Text>
                  </View>
