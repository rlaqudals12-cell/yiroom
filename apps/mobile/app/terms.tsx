    ...
    <View>
      ...
      <View style={styles.section}>
        ...
        <Paragraph colors={colors}>
          이 약관은 이룸(이하 "회사")이 제공하는 통합 웰니스 AI 플랫폼
      ...
      <View style={styles.section}>
        ...
        <BulletItem colors={colors}>
          "서비스"란 회사가 제공하는 퍼스널컬러 진단, 피부 분석, 체형 분석,
          운동/영양 관리, AI 코칭 등의 웰니스 서비스를 말합니다.
        </BulletItem>
        <BulletItem colors={colors}>
        ...
        <BulletItem colors={colors}>
          "AI 분석"이란 이용자가 업로드한 이미지를 기반으로 인공지능이 수행하는
          진단 및 분석 서비스를 말합니다.
        </BulletItem>
      </View>
      ...
      <View style={styles.section}>
        ...
        <BulletItem colors={colors}>
          회사는 필요한 경우 관련 법령을 위반하지 않는 범위에서 이 약관을 변경할
          수 있습니다.
        </BulletItem>
        <BulletItem colors={colors}>
          약관이 변경되는 경우, 회사는 변경 사항을 시행일 7일 전부터 서비스 내
          공지합니다.
        </BulletItem>
      </View>
      ...
      <View style={styles.section}>
        ...
        <BulletItem colors={colors}>
          소셜 기능 (친구, 피드, 챌린지, 리더보드)
        </BulletItem>
        <BulletItem colors={colors}>
          기타 회사가 추후 개발하여 제공하는 서비스
        </BulletItem>
      </View>
      ...
      <View style={styles.section}>
        ...
        <Paragraph colors={colors}>
          AI 분석 결과는 참고 목적으로만 제공되며, 의학적 진단이나 전문적 조언을
          대체하지 않습니다. 분석 결과에 따른 의사결정은 이용자 본인의
          책임입니다.
        </Paragraph>
        <BulletItem colors={colors}>
      ...
      <View style={styles.section}>
        ...
        <BulletItem colors={colors}>
          탈퇴 시 개인정보 및 서비스 이용 기록은 개인정보처리방침에 따라
          처리됩니다.
        </BulletItem>
      </View>
      ...
      <View style={styles.section}>
        ...
        <Paragraph colors={colors}>
          서비스에서 제공되는 콘텐츠(AI 분석 알고리즘, UI 디자인, 텍스트 등)의
          저작권은 회사에 귀속됩니다. 이용자는 서비스를 이용하여 얻은 정보를
          개인적 용도로만 사용할 수 있습니다.
        </Paragraph>
      </View>
      ...
      <View style={styles.section}>
        ...
        <Paragraph colors={colors}>
          이 약관에 관한 분쟁은 대한민국 법령에 따라 해결하며, 회사의 본사
  ...
  return (
    <View>
      ...
      <View style={styles.section}>
        ...
        <Paragraph colors={colors}>
          These Terms of Service ("Terms") govern the use of the integrated
          wellness AI platform service ("Service") provided by Yiroom
          ("Company") and define the rights, obligations, and responsibilities
      ...
      <View style={styles.section}>
        ...
        <BulletItem colors={colors}>
          "Service" refers to the wellness services provided by the Company,
          including personal color diagnosis, skin analysis, body type analysis,
          workout/nutrition management, and AI coaching.
        </BulletItem>
        <BulletItem colors={colors}>
          "User" refers to members and non-members who use the Service in
          accordance with these Terms.
        </BulletItem>
        <BulletItem colors={colors}>
          "Member" refers to a person who has registered as a member by
          providing personal information to the Company.
        </BulletItem>
        <BulletItem colors={colors}>
          "AI Analysis" refers to the diagnosis and analysis services performed
          by artificial intelligence based on images uploaded by users.
        </BulletItem>
      </View>
      ...
      <View style={styles.section}>
        ...
        <BulletItem colors={colors}>
          The Company may modify these Terms as necessary, within the scope of
          applicable laws.
        </BulletItem>
        <BulletItem colors={colors}>
          Changes will be announced within the Service at least 7 days before
          the effective date.
        </BulletItem>
      </View>
      ...
      <View style={styles.section}>
        ...
        <BulletItem colors={colors}>
          AI-based analysis services (personal color, skin, body type, hair,
          makeup, oral health)
        </BulletItem>
        <BulletItem colors={colors}>
          Workout and nutrition management services
        </BulletItem>
        <BulletItem colors={colors}>AI wellness coaching services</BulletItem>
        <BulletItem colors={colors}>
          Personalized product recommendation services
        </BulletItem>
        <BulletItem colors={colors}>
      ...
      <View style={styles.section}>
        <SectionTitle colors={colors}>
          Article 5. AI Analysis Disclaimer
        </SectionTitle>
        <Paragraph colors={colors}>
          AI analysis results are provided for reference purposes only and do
          not replace medical diagnosis or professional advice. Users are
          responsible for decisions made based on analysis results.
        </Paragraph>
        <BulletItem colors={colors}>
          AI analysis results may vary depending on image quality, lighting, and
      ...
      <View style={styles.section}>
        ...
        <BulletItem colors={colors}>
          Reproducing or distributing information obtained through the Service
          without prior consent
        </BulletItem>
        <BulletItem colors={colors}>
          Interfering with the Company's service operations
        </BulletItem>
        <BulletItem colors={colors}>
          Defaming or disadvantaging other users
        </BulletItem>
        <BulletItem colors={colors}>
      ...
      <View style={styles.section}>
        ...
        <Paragraph colors={colors}>
          The Company may temporarily suspend the Service for maintenance,
          replacement, or failure of information and communication facilities,
          or in the event of communication disruptions.
        </Paragraph>
      </View>
      ...
      <View style={styles.section}>
        ...
        <BulletItem colors={colors}>
          Members may request account termination at any time, and the Company
          will process it immediately.
        </BulletItem>
        <BulletItem colors={colors}>
          Upon termination, personal data and service usage records will be
      ...
      <View style={styles.section}>
        ...
        <Paragraph colors={colors}>
          Copyright of content provided through the Service (AI analysis
          algorithms, UI design, text, etc.) belongs to the Company. Users may
          only use information obtained through the Service for personal
          purposes.
        </Paragraph>
      </View>
      ...
      <View style={styles.section}>
        ...
        <Paragraph colors={colors}>
          Disputes related to these Terms shall be resolved in accordance with
          the laws of the Republic of Korea, and the court with jurisdiction
          over the Company's headquarters shall be the exclusive court of
          jurisdiction.
        </Paragraph>
      </View>
