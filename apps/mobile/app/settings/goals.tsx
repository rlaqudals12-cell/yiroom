...
export default function GoalsSettingsScreen() {
  ...
  return (
    <ScreenContainer testID="settings-goals-screen" edges={['bottom']} backgroundGradient="profile">
      {/* 물 목표 */}
      ...
      <Animated.View entering={FadeInUp.delay(160).duration(TIMING.normal)} style={styles.section}>
        ...
        <GlassCard shadowSize="md" style={styles.card}>
          ...
          {/* 주당 운동 횟수 */}
          <View style={[styles.goalRow, styles.goalRowBorder, { borderTopColor: colors.border }]}>
