    ...
    avoid: [
      {
        ...
        category: 'avoid',
        useCase: '옷, 립스틱',
        reason: '웜톤 색상이라 피부가 노랗게 보일 수 있어요',
      },
      {
        colorName: '카키',
        hexCode: '#8B8970',
