...
export const QUICK_QUESTIONS_BY_CATEGORY = {
  ...
  skin: [
    ...
    '제 피부에 맞는 루틴 알려줘요',
    // Phase D: 피부 상담 질문 확장
    '제 피부 타입에 맞는 세럼 추천해줘요',
    '모공 관리는 어떻게 해야 해요?',
    '피부 컨디션이 안 좋을 땐 어떻게 관리해요?',
    '수면과 피부의 관계가 뭐예요?',
  ],
  hair: [
    '머리가 빠지는 것 같은데 어떡해요?',
  ...
  // ADR-114: 기본(미지정) 화면 = 상황형 4종. "이 제품 나한테 맞을까요?"는
  // 채팅 전송이 아니라 /scan 링크 칩으로 분기(사진 판정 정본=스캔) → ChatInterface에서 별도 렌더.
  ...
  // Phase K: 패션 상담 확장
  fashion: [
    // 한 목록 안 존댓말·반말 혼용 금지 — 해요체로 통일 (2026-08-17 카피 감사)
    '오늘 면접인데 뭐 입으면 좋을까요?',
    '내 옷장에서 데이트룩 추천해줘요',
    '이 상의에 어울리는 하의는?',
    '내 퍼스널컬러에 맞는 코디 알려줘요',
