...
⚠️ 표현 규칙 (미용 관점만 — 필수 준수):
- 질병명(예: 주사, 지루성 피부염, 모낭염 등)을 진단하거나 언급하지 말고, 미용 관점의 상태만 기술하라. 의학적 진단·치료 표현 금지.
- 홍조/붉은기·유분·각질·트러블 등 관찰 가능한 미용 상태 용어로만 insight와 description을 작성하라.

📊 피부과학 기반 점수화 기준 (docs/principles/skin-physiology.md 근거):

참고 — 한국인 피부 기준 (Corneometer/Sebumeter 연구, n=361):
  평균 수분: Corneometer 47.17 A.U.
  평균 피지(이마): Sebumeter 112 μg/cm²
  평균 피지(볼): Sebumeter 42 μg/cm²
  민감성 기준: TEWL > 18.0 g/m²/h, pH > 5.45

━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
[수분도 hydration] — TEWL 기반 추정
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
관찰 신호 → TEWL 추정 → 점수:
  심한 건조선/당김/거친 각질 박리: TEWL 높음(>18) → 0-30점
  약간 건조하거나 입가 당김: TEWL 중간(10-18) → 31-55점
  보통 질감, 특이사항 없음: TEWL 정상(5-10) → 56-75점
  부드럽고 촉촉한 광택: TEWL 낮음(<5) → 76-100점
존별: U존(볼/눈가) 중심으로 평가 (T존은 유분에 가려짐)

━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
[유분도 oil] — T존/U존 Sebumeter 기준
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
T존(이마/코) — 피지선 밀도 400-900개/cm²:
  매우 번들거림 + 블랙헤드 다수: 이마 피지 > 150 μg/cm² → 75-100점
  약간 번들거림: 이마 피지 70-150 μg/cm² → 40-74점
  광택 없음/건조: 이마 피지 < 70 μg/cm² → 0-39점

U존(볼) — 피지선 밀도 낮음:
  볼 번들거림 확인: 볼 피지 > 70 μg/cm² → 높음
  정상: 볼 피지 30-70 μg/cm² → 보통
  건조: 볼 피지 < 30 μg/cm² → 낮음

복합성 판정: T존 oil ≥ 60 AND U존 hydration ≤ 45 → "combination"

━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
[모공 pores] — 한국인/동아시아인 기준
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
한국인 모공 특성: 동아시아인은 모공이 가장 작음 (0.03-0.06 mm²)
코 모공:
  눈에 띄게 확대(>0.2 mm²): 0-40점
  보통(0.08-0.15 mm²): 41-70점
  작고 밀집(<0.08 mm²): 71-100점
볼 모공:
  가시적이면 이미 "확대된 모공" (동아시아인 기준)
가시성 지수(PVI): 높으면 점수 하향, 낮으면 상향

━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
[주름 wrinkles]
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
표면 거칠기 (Ra 추정, ISO 4287):
  Ra > 40 μm: 심한 주름/거친 질감 → 0-40점
  Ra 13-35 μm: 경미한 잔주름 → 41-70점
  Ra < 13 μm: 매끈한 피부 → 71-100점
부위: 눈가 잔주름, 이마 주름, 팔자주름 각각 확인
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
Cutometer 기반 추정:
  볼 처짐, 턱선 흐릿, 이중턱: 탄력 저하 → 0-40점
  약간의 처짐, 턱선 보통: → 41-70점
  팽팽, 턱선 선명, 윤곽 뚜렷: → 71-100점

━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
[색소침착 pigmentation] — Lab a*/b* 기반
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
유형 구분:
  기미(melasma): 볼/이마 갈색 패치, 대칭적
  잡티(freckles): 작은 점상, 불규칙
  검버섯(solar lentigo): 경계 명확한 갈색 반점
  다크서클: 눈 아래 색소
범위와 농도로 점수:
  깨끗(소수 또는 없음): 71-100점
  약간(부분적 잡티): 41-70점
  많음(넓은 범위 기미/검버섯): 0-40점

━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
[트러블 trouble] — 여드름 vs 민감성 구분
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
⚠️ 중요: 트러블과 민감성은 다른 것

트러블(여드름):
  화이트헤드/블랙헤드(비염증): 개수로 점수
  구진/농포(염증성): 5개+ → 0-40점
  1-4개: 41-70점
  없음/흔적만: 71-100점

민감성(sensitivityLevel 별도):
  장벽 손상 = TEWL 높음 + 붉은기 균일 + 건조 → "high"
  염증 반응 = 여드름 + 패치형 홍조 → 트러블이지 민감성은 아닐 수 있음
  자극 반응 = 따끔/가려움 (이미지에서 판단 불가 → 물어봐야 함)

━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
[수면-피부 상관] — 수면 데이터 있을 때
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
수면 부족(< 6시간):
  → 피부 재생 저하 → hydration -10~15점 보정, elasticity -5~10점
  → 다크서클 악화 → pigmentation 점수 하향
  → "충분한 수면(7-8시간)이 피부 개선의 기본입니다" 인사이트 포함

━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
[생리주기-피부 상관] — 주기 데이터 있을 때
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
생리기(1-5일): 피부 건조↑, 민감↑ → 자극 최소화 루틴
여포기(6-13일): 에스트로겐↑ → 피부 최상 상태
배란기(14일): 피지↑ → T존 유분 관리 강화
황체기(15-28일): 프로게스테론↑ → 여드름 위험↑, 부기↑
  → "현재 생리주기 단계에 맞는 케어" 인사이트 포함

━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
[홍조/붉은기] — Lab a* 추정
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
볼의 붉은기 강도 (Lab a* 추정):
  정상 피부톤: a* 8-12 → rednessLevel "none" 또는 "slight"
  약간 높음: a* 12-15 → rednessLevel "moderate"
  높음: a* > 15 → rednessLevel "severe"
코/이마 a* > 18 → 홍조·붉은기 강함, 민감성 높음 (질환명 언급 금지 — '홍조 경향'으로만 기술)
...

{
  ...
  "cleansingRoutine": {
    "method": "[double_cleanse|single_cleanse|oil_only|water_only]",
    "methodLabel": "[이중세안|단일세안|오일세안|물세안]",
    "tZone": "[피부타입 맞춤 T존 세안법 1문장]",
    "uZone": "[피부타입 맞춤 U존 세안법 1문장]",
    "temperature": "[cold|lukewarm|warm] 세안 온도 (약산성 36-37°C 권장)",
    "weeklySpecial": "[주 n회 각질 관리 방법 — AHA/BHA/PHA 중 피부타입에 맞는 것]"
  },
  "dailyCareRoutine": {
    "morning": ["[아침 스텝1]", "[스텝2]", "[스텝3]"],
    "evening": ["[저녁 스텝1]", "[스텝2]", "[스텝3]", "[스텝4]"],
    "weekly": ["[주간 스페셜 케어]"]
  }
}
...
세안법 기준 (Draelos, 2018):
- T존 지성 + U존 건조 (복합성): T존 이중세안(오일+폼) + U존 밀크 단일세안
- 전체 지성: 약산성 폼(pH 5.5), 이중세안, 주 2회 BHA 2%
- 전체 건성: 밀크/크림 클렌저 단일세안, 36°C 미온수
- 민감성: pH 5.5 이하 세안제, 문지르지 않기, 1분 이내 세안
- 각질 관리: 건성→주 1회 AHA 5-8%, 지성→주 2회 BHA 2%, 민감→PHA
 ...
 */
const BODY_ANALYSIS_PROMPT = `당신은 전문 체형 분석 AI입니다. 업로드된 전신 이미지를 분석하여 골격 타입을 판별해주세요.
...
📐 비율 기반 판정 보조 (docs/principles/body-mechanics.md):
어깨:허리:골반 비율 — 이미지에서 상대적 너비 추정:
  S타입: 어깨 ≥ 골반, 허리/골반 비율 > 0.8 (직선적)
  W타입: 골반 > 어깨, 허리/골반 비율 < 0.75 (곡선적)
  N타입: 어깨 ≈ 골반 (±5%), 프레임이 큰 느낌

상체:하체 비율 — 허리선 기준:
  허리선이 높으면 (상체 짧음) → S타입 경향
  허리선이 낮으면 (하체 짧음) → W타입 경향
  허리선이 균형 → N타입 경향

━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
📐 자세 불균형 감지 (Janda, 1979)
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
상위 교차 증후군 (Upper Crossed Syndrome):
  관찰: 머리 전방 돌출 + 둥근 어깨 + 과도한 흉추 후만
  원인: 흉근/상부승모근 단축 + 심층 경근/하부승모근 약화
  → 어깨가 앞으로 말림, 목이 앞으로 나옴

하위 교차 증후군 (Lower Crossed Syndrome):
  관찰: 과도한 요추 전만 + 복부 돌출 + 엉덩이 후방 돌출
  원인: 고관절 굴곡근/요추기립근 단축 + 복근/대둔근 약화
  → 골반이 앞으로 기울어짐

좌우 비대칭:
  - 어깨 높이: 왼쪽/오른쪽 차이
  - 골반 기울기: 좌우 높이 및 전후 기울기
  - 무릎/발목 정렬: O자형/X자형 다리
  - 비대칭이 발견되면 asymmetryAnalysis 필드에 기록

자세 → 운동 연결:
  상위 교차 → "가슴 스트레칭 + 등 강화 운동 필요"
  하위 교차 → "고관절 스트레칭 + 복근/둔근 강화 필요"
  → styleRecommendations에 자세 교정 인사이트 포함할 것
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
📐 Lab 수치 기반 판정 보조 (Level 2)
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
피부의 Lab 값을 추정하여 판정 정확도를 높이세요:

한국인 피부 평균: L*=63, a*=10, b*=18.5 (Puzovic 2012)

색상각 h° = atan2(b*, a*):
  h° < 55° → 쿨톤 | 55-60° → 뉴트럴 | h° > 60° → 웜톤

ITA = atan2(L*-50, b*):
  웜+밝음(ITA>41°) → Spring | 웜+어두움 → Autumn
  쿨+밝음(ITA>41°) → Summer | 쿨+어두움 → Winter

채도 C* = sqrt(a²+b²):
  C*<14 → Muted | 14≤C*<20 → True | C*≥20 → Bright

경계 케이스 (h° 55-60°): confidence -15
한국인 분포: 가을 22.8% > 여름 18.4% > 봄 18.2% > 겨울 10.4%
Winter 판정은 확실한 근거(L*<54, h°<55°, 높은 대비) 없으면 금지
...
## 📐 운동생리학 원리 (docs/principles/exercise-physiology.md)

점진적 과부하 (Selye, 1936):
  - 주간 운동 볼륨 증가: 5-10% (급격한 증가 금지)
  - 초보자: 체중 운동 → 저중량 고반복 → 점진적 증량
  - 중급자: 주당 근육군별 10-20세트

근비대 기전 (Schoenfeld, 2010):
  - BUILDER 타입: 세트당 6-12회, 중량 65-85% 1RM
  - TONER 타입: 세트당 12-20회, 중량 50-65% 1RM
  - BURNER 타입: HIIT 20초 운동 + 10초 휴식 × 8세트 (Tabata)

체형별 운동 처방 (ACSM Guidelines):
  S타입(스트레이트): 상체 볼륨 이미 있음 → 하체+코어 비율 높이기
  W타입(웨이브): 하체 볼륨 있음 → 상체+등 강화, 하체는 라인 위주
  N타입(내추럴): 프레임 큼 → 전신 균형, 유연성 강화 필수

자세 교정 운동 (Janda Cross Syndrome):
  상위 교차 → 가슴 스트레칭 + 하부승모근/능형근 강화 (밴드풀아파트, 페이스풀)
  하위 교차 → 고관절 굴곡근 스트레칭 + 복근/대둔근 강화 (데드버그, 힙브릿지)
  → 자세 불균형이 있으면 교정 운동을 플랜에 반드시 포함

부상별 대체 운동:
  무릎 부상 → 풀스쿼트 ❌ → 박스스쿼트/레그프레스(가동범위 제한)
  허리 디스크 → 데드리프트 ❌ → 맥길 코어 3대 운동(컬업/사이드브릿지/버드독)
  어깨 충돌 → 오버헤드프레스 ❌ → 랜드마인프레스/케이블레이즈

## ⚠️ 우선순위 규칙

- **부상 부위 > 운동 목표**: 부상이 있으면 해당 부위 회피가 최우선
- **자세 교정 > 강도 증가**: 자세 문제 있으면 교정 운동 먼저
...
// ────────────────────────────────────────────────────────────
// 의료기기법 방어(defense-in-depth): 사용자 대면 자유 텍스트 세탁
// ────────────────────────────────────────────────────────────
// 왜: 이룸은 미용(비의료) 앱이다. AI가 insight/description 등 자유 텍스트에
// 질병명(주사·지루성 피부염·모낭염·탈모증 등)을 실으면 "질병 진단"으로 읽혀
// 의료기기(SaMD) 규제 대상으로 오인될 수 있다. 프롬프트에서 1차로 질환명 언급을
// 금지하고, 여기서 2차로 출력 텍스트를 미용 표현으로 치환한다.
//
// 보수적 원칙: 명백한 질환명만 치환한다. '여드름'·'염증' 같은 경계 용어는
// 미용 상태 표현으로도 통용되므로 건드리지 않는다(오탐/문맥 훼손 방지).
// 긴 표현을 먼저 치환해야 부분 매칭 순서가 보장된다(예: '지루성 피부염' → '지루성').
const MEDICAL_TERM_SCRUB: ReadonlyArray<readonly [RegExp, string]> = [
  [/지루성\s*(피부염|두피염|두피 ?염)/g, '유분·각질 상태'],
  [/지루성/g, '유분 경향'],
  [/모낭염/g, '모공 주변 트러블'],
  [/탈모증/g, '모발 밀도 저하'],
  [/로사시아/g, '홍조 경향'],
  [/주사\s*\(\s*rosacea\s*\)/gi, '홍조 경향'], // '주사(rosacea)' 병기 형태 먼저
  [/rosacea/gi, '홍조 경향'],
  [/주사(?![기제액])/g, '홍조 경향'], // 피부/두피 맥락의 '주사'(=rosacea). 주사기/주사제/주사액은 제외
];

/** 자유 텍스트 한 줄을 미용 표현으로 세탁 */
function scrubMedicalTerms(text: string): string {
  if (!text) return text;
  return MEDICAL_TERM_SCRUB.reduce(
...
/**
 * S-1 결과의 사용자 대면 자유 텍스트만 세탁한다.
 * 점수·구조·enum·Mock 폴백 로직은 절대 건드리지 않는다(제네릭으로 12존 확장 타입도 보존).
 */
function scrubSkinAnalysisText<T extends GeminiSkinAnalysisResult>(result: T): T {
  result.insight = scrubMedicalTerms(result.insight);
  result.metrics = result.metrics.map((m) => ({
    ...m,
    description: scrubMedicalTerms(m.description),
  }));
  result.concernAreas = result.concernAreas.map(scrubMedicalTerms);
  result.recommendedIngredients = result.recommendedIngredients.map((i) => ({
    ...i,
    reason: scrubMedicalTerms(i.reason),
    efficacy: i.efficacy ? scrubMedicalTerms(i.efficacy) : i.efficacy,
  }));
  if (result.avoidIngredients) {
    result.avoidIngredients = result.avoidIngredients.map((i) => ({
      ...i,
      reason: scrubMedicalTerms(i.reason),
    }));
  }
  if (result.problemAreas) {
    result.problemAreas = result.problemAreas.map((p) => ({
      ...p,
      description: scrubMedicalTerms(p.description),
    }));
  }
  return result;
}

/** H-1 결과의 사용자 대면 자유 텍스트만 세탁한다(점수·구조 불변). */
function scrubHairAnalysisText(result: GeminiHairAnalysisResult): GeminiHairAnalysisResult {
  result.insight = scrubMedicalTerms(result.insight);
  result.metrics = result.metrics.map((m) => ({
    ...m,
    description: scrubMedicalTerms(m.description),
  }));
  result.concerns = result.concerns.map(scrubMedicalTerms);
  result.careTips = result.careTips.map(scrubMedicalTerms);
  result.recommendedIngredients = result.recommendedIngredients.map(scrubMedicalTerms);
  result.recommendedProducts = result.recommendedProducts.map((p) => ({
    ...p,
    description: scrubMedicalTerms(p.description),
  }));
  return result;
...
export async function analyzeSkin(
  ...
  try {
    ...
    // 반환 전 질환명 세탁 (의료기기법 방어)
    return scrubSkinAnalysisText(parseJsonResponse<GeminiSkinAnalysisResult>(text));
  } catch (error) {
    // 조용한 mock 폴백 제거 (2026-07-07): 여기서 반환하던 generateMockSkinAnalysis는
    // GeminiSkinAnalysisResult와 스키마도 안 맞아(skinType undefined) 깨진 결과가
    // usedMock=false(실분석)로 저장되던 이중 버그 — 재현성 테스트에서 실측 발견.
    // 유일한 호출처인 라우트 catch가 완전한 mock+usedMock=true를 처리.
    geminiLogger.error('[S-1] Gemini error, rethrowing (route에서 mock 폴백):', error);
    throw error;
  }
}
...
export async function analyzeSkinDetailed(
  ...
  try {
    ...
    const result = await withRetry(
      () =>
        withTimeout(
          generateContent({
            contents: [
              { text: `${SKIN_ANALYSIS_DETAILED_PROMPT}\n\n${outputLanguageDirective(locale)}` },
              imagePart,
            ],
            config: geminiConfig,
          }),
    ...
    // 반환 전 질환명 세탁 (의료기기법 방어) — 12존 확장 타입도 제네릭으로 보존
    return scrubSkinAnalysisText(parseJsonResponse<GeminiDetailedSkinAnalysisResult>(text));
  } catch (error) {
...
✅ imageQuality.analysisReliability를 "high"로 설정`;
    ...
    // 조용한 mock 폴백 제거 (2026-07-07): 사유는 M-1과 동일 — 라우트 catch가
    // 완전한 mock+usedMock=true를 처리하므로 여기선 전파만.
    geminiLogger.error('[C-1] Gemini error, rethrowing (route에서 mock 폴백):', error);
    throw error;
  }
}
...
3. 보정 적용 시 confidence +5 보너스
종이가 없어도 분석은 정상 진행`;

    // 결과 자유 텍스트(컬러명·insight·스타일 설명)만 사용자 언어로 (JSON 필드·enum·hex는 영문 유지)
    prompt += `\n\n${outputLanguageDirective(locale)}`;
...
## 📐 크로스 모듈 영양 원리 (docs/principles/nutrition-science.md)

피부-영양 상관 (Schagen et al., 2012):
  건조 피부 → 오메가-3 1-2g/일 (연어, 호두, 아마씨) + 비타민E
  여드름/트러블 → 아연 15mg + 비타민A (당근, 고구마) + 저GI 탄수화물
  색소침착 → 비타민C 500-1000mg (키위, 파프리카) + 글루타치온
  탄력 저하 → 콜라겐 합성: 비타민C + 프롤린(달걀, 유제품) + 구리
  홍조/민감 → 항산화제(비타민C/E) + 프로바이오틱스 + 오메가-3

운동-영양 타이밍 (ISSN Position Stand, Kerksick 2017):
  운동 전 2시간: 복합 탄수화물 + 소량 단백질 (바나나+그릭요거트)
  운동 후 30분: 유청 단백질 20-40g + 단순 탄수화물 (쉐이크+바나나)
  취침 전: 카제인 30-40g (우유, 코티지치즈) → 야간 근합성
  체중 감량 시: 운동 전 공복 유산소 가능하나 근력 운동 시 식사 필수

모발-영양 (Almohanna et al., 2019):
  탈모 위험 → 철분(페리틴 < 30ng/mL), 아연, 비오틴 2.5-5mg
  두피 건조 → 오메가-3 + 비타민D 2000IU
  윤기 부족 → 비오틴 + 아미노산(케라틴 구성)

영양소 상호작용 (주의):
  ✅ 철분 + 비타민C = 흡수율 2-3배↑ (같이 섭취)
  ❌ 칼슘 + 철분 = 흡수 경쟁 (2시간 간격)
  ❌ 카페인 + 철분 = 흡수 60%↓ (식후 2시간 후 커피)
  ✅ 비타민D + K2 = 칼슘 대사 시너지 (같이 섭취)
  ✅ 지용성 비타민(A/D/E/K) = 지방과 함께 (식사 중 섭취)
 ...
 * A-1 자세 분석 프롬프트
 */
const POSTURE_ANALYSIS_PROMPT = `당신은 전문 자세 분석 AI입니다. 업로드된 전신 이미지를 분석하여 자세 상태를 판별해주세요.
...
⚠️ 표현 규칙 (미용 관점만 — 필수 준수):
- 질병명(예: 탈모증, 지루성 두피염, 모낭염 등)을 진단하거나 언급하지 말고, 미용 관점의 상태만 기술하라. 의학적 진단·치료 표현 금지.
- 모발 밀도·볼륨 상태, 두피 유분·각질·붉은기 등 관찰 가능한 미용 상태 용어로만 insight와 description을 작성하라.

📊 과학적 분석 기준 (docs/principles/trichology):

참고 — 모발-영양 상관 (Almohanna et al., 2019):
  모발 밀도·볼륨 저하 경향: 가늘어짐+밀도 저하+두피 붉은기 → 철분/아연/비오틴 등 영양 보충 여지 (질환 아님, 미용 상태로만 기술)
  윤기 부족: 오메가-3 + 비오틴 부족 가능
  두피 건조: 비타민D 부족 + 수분 섭취 부족 가능
  → 영양 연동 인사이트를 insight 필드에 반드시 포함

참고 — PC 시즌별 헤어 컬러 추천:
  봄 웜톤: 따뜻한 갈색, 카라멜, 구릿빛
  여름 쿨톤: 애쉬 브라운, 라벤더, 시원한 톤
  가을 웜톤: 다크 브라운, 체스트넛, 구리빛
  겨울 쿨톤: 블랙, 다크 애쉬, 버건디
  → PC-1 시즌이 알려진 경우 헤어 컬러 추천에 반영

참고 — 얼굴형별 헤어스타일 추천 (docs/principles/3d-face-shape.md):
  타원형(oval): 대부분의 스타일 가능, 이마를 열어도 닫아도 OK
  둥근형(round): 볼륨은 정수리 위로, 옆 볼륨 줄이기, 긴 앞머리/레이어드
  각진형(square): 부드러운 웨이브, 사이드뱅, 턱선 아래 길이
  하트형(heart): 턱 라인 볼륨, 사이드 파팅, 이마 커버 뱅
  긴 얼굴(oblong): 가로 볼륨(웨이브/컬), 풀뱅, 턱선 길이 밥컷
  다이아몬드(diamond): 턱선 레이어, 사이드 파팅, 관대 축소 볼륨
  → 이미지에서 얼굴형도 함께 추정하여 hairStyleRecommendations에 반영

참고 — 모발 타입별 스타일 제약:
  직모(straight) + 가늘음: 볼륨 펌, 레이어드 필수
  곱슬(curly) + 굵음: 무거움 줄이기, 긴 레이어
  웨이브(wavy): 자연스러운 텍스처 살리기
  → recommendedStyles에 모발 타입 제약 반영
...
- 두피 색상, 각질, 붉은기 유무
- 모공 주변 상태, 붉은기 확인
- 두피 홍조: a* > 15 → 두피 붉은기·민감 경향, 민감 케어 필수 (질환명 언급 금지)
- 좋음: 71-100, 보통: 41-70, 주의: 0-40
...

{
  ...
  "hairStyleRecommendations": {
    ...
    "recommendedStyles": [
      {"name": "[헤어스타일명]", "reason": "[모발타입+얼굴형 기반 추천 이유]"},
      {"name": "[헤어스타일명]", "reason": "[추천 이유]"}
    ],
    "avoidStyles": ["[피해야 할 스타일1]"],
    "colorSuggestion": "[PC 시즌 기반 추천 헤어 컬러, 모르면 null]"
  },
  "scalpCareRoutine": {
    "step1": "[세정 방법 — 두피 타입 맞춤]",
    "step2": "[토닉/앰플 — 두피 상태 맞춤]",
    "step3": "[마사지 — 혈행 개선 방법]",
    "frequency": "[주 n회 딥클렌징 등]"
  },
  "analysisReliability": "[high|medium|low]",
  "imageQuality": {
    "lightingCondition": "[natural|artificial|mixed]",
...
export async function analyzeHair(
  imageBase64: string,
  locale: OutputLocale = 'ko'
): Promise<GeminiHairAnalysisResult> {
  ...
  try {
    ...
    // 반환 전 질환명 세탁 (의료기기법 방어)
    return scrubHairAnalysisText(parseJsonResponse<GeminiHairAnalysisResult>(text));
  } catch (error) {
    // 조용한 mock 폴백 제거 (2026-07-07): 사유는 M-1과 동일 — 라우트 catch가
    // 완전한 mock+usedMock=true를 처리하므로 여기선 전파만.
    geminiLogger.error('[H-1] Gemini error, rethrowing (route에서 mock 폴백):', error);
    throw error;
  }
}
...
PC-1 퍼스널컬러 연동 (docs/principles/color-matching-theory.md):
  봄 웜톤 → 코랄/피치 립, 골드 하이라이터, 따뜻한 아이섀도
  여름 쿨톤 → 로즈/핑크 립, 실버 하이라이터, 라벤더 아이섀도
  가을 웜톤 → 테라코타/누드 립, 골드 하이라이터, 브라운 아이섀도
  겨울 쿨톤 → 레드/와인 립, 실버 하이라이터, 스모키 아이섀도
  → 추천 색상이 PC 시즌과 일치해야 함

S-1 피부 상태 연동:
  건성 피부 → 보습 쿠션/파운데이션, 크림 블러셔 (파우더 피하기)
  지성 피부 → 매트 파운데이션, 파우더 세팅, 오일 컨트롤 프라이머
  민감 피부 → 미네랄 파운데이션, 무향/저자극 제품 추천
  여드름 많음 → 풀 커버리지, 색보정(그린 컨실러), 논코메도제닉

얼굴형별 메이크업 기법:
  둥근형(round) → 컨투어링으로 각 강조, 아이브로우 각도 있게
  긴 얼굴(oblong) → 가로 블러셔, 이마+턱 쉐딩
  각진형(square) → 부드러운 블러셔 위치, 곡선 강조
  하트형(heart) → 턱 하이라이트, 이마 쉐딩
...
5. 크로스 모듈 원리(PC 시즌, 피부 상태, 얼굴형)를 반영하여 맞춤 추천하세요.
...
export async function analyzeMakeup(
  ...
  try {
    ...
    // 조용한 mock 폴백 제거 (2026-07-07): 여기서 mock을 반환하면 유일한 호출처인
    // 라우트의 catch가 안 불려 usedMock=false로 기록 — Mock 결과가 실분석으로
    // 저장·표시되는 ADR-007 위반. 라우트 catch가 완전한 mock+usedMock=true 처리.
    geminiLogger.error('[M-1] Gemini error, rethrowing (route에서 mock 폴백):', error);
    throw error;
  }
}
