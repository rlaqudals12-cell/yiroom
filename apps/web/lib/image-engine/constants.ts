...
export const FEEDBACK_MESSAGES = {
  sharpness: {
    rejected: '이미지가 너무 흐려요. 초점을 맞추고 다시 촬영해주세요.',
    warning: '이미지가 다소 흐려요. 가능하다면 더 선명한 이미지를 사용해주세요.',
    acceptable: '이미지 선명도가 적절해요.',
    optimal: '이미지 선명도가 매우 좋아요.',
  },
  exposure: {
    underexposed: '이미지가 너무 어두워요. 조명을 밝게 하고 다시 촬영해주세요.',
    normal: '노출이 적절해요.',
    overexposed: '이미지가 너무 밝아요. 조명을 줄이고 다시 촬영해주세요.',
  },
  cct: {
    tooWarm: '조명이 너무 따뜻해요. 자연광 또는 주광색 조명을 사용해주세요.',
    warm: '조명이 약간 따뜻해요.',
    neutral: '조명 색온도가 적절해요.',
    cool: '조명이 약간 차가워요.',
    tooCool: '조명이 너무 차가워요. 따뜻한 조명을 추가해주세요.',
  },
  face: {
    notDetected: '얼굴을 감지할 수 없어요. 얼굴이 잘 보이도록 촬영해주세요.',
    multipleFaces: '여러 얼굴이 감지됐어요. 가장 크고 정면인 얼굴을 선택해요.',
    angleWarning: '얼굴 각도가 너무 기울어져 있어요. 정면을 바라보고 촬영해주세요.',
    lowConfidence: '얼굴 감지 신뢰도가 낮아요. 조명을 개선하고 다시 시도해주세요.',
  },
  shadow: {
    none: '그림자가 감지되지 않았어요.',
    mild: '약간의 그림자가 있어요.',
    moderate: '한쪽에 그림자가 있어요. 균일한 조명을 사용해주세요.',
    severe: '심한 그림자가 감지됐어요. 조명 위치를 조정해주세요.',
  },
  resolution: {
    tooSmall: '이미지 해상도가 너무 낮아요. 최소 640x480 이상의 이미지를 사용해주세요.',
    acceptable: '이미지 해상도가 적절해요.',
  },
} as const;
