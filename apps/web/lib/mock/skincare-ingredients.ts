...
export const CLEANSER_INGREDIENTS: Ingredient[] = [
  // 계면활성제
  {
    ...
    category: 'surfactant',
    rating: 'caution',
    description: '강력한 거품과 세정력을 제공하는 음이온 계면활성제예요.',
  ...
  },
  {
    ...
    category: 'surfactant',
    rating: 'neutral',
    description: 'SLS보다 순한 계면활성제로, 여전히 좋은 세정력을 제공해요.',
  ...
  },
  {
    ...
    category: 'surfactant',
    rating: 'good',
    description: '코코넛 유래 순한 양쪽성 계면활성제예요.',
  ...
  },
  {
    ...
    category: 'surfactant',
    rating: 'good',
    description: '옥수수와 코코넛 유래 매우 순한 비이온 계면활성제예요.',
  ...
  },
  {
    ...
    category: 'surfactant',
    rating: 'good',
    description: '코코넛 유래의 순한 계면활성제로, "베이비 폼"이라고도 불려요.',
  ...
  // 오일 성분
  {
    ...
    rating: 'good',
    description: '피부 친화적인 오일로, 클렌징 오일에 많이 사용돼요.',
  ...
  },
  {
    ...
    category: 'moisturizer',
    rating: 'neutral',
    description: '정제된 석유 유래 오일로, 클렌징력이 좋아요.',
  ...
  },
  {
    ...
    category: 'moisturizer',
    rating: 'good',
    description: '피부 피지와 유사한 구조의 식물성 왁스 에스터예요.',
  ...
  // 효소
  {
    ...
    category: 'active',
    rating: 'neutral',
    description: '파파야에서 추출한 단백질 분해 효소예요.',
  ...
  },
  {
    ...
    category: 'active',
    rating: 'neutral',
    description: '파인애플에서 추출한 단백질 분해 효소예요.',
