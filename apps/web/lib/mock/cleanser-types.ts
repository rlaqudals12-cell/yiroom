...
export const CLEANSER_TYPES: CleanserType[] = [
  {
    ...
    phMin: null,
    phMax: null,
    description: '유성 메이크업과 선크림을 효과적으로 제거하는 1차 클렌저예요.',
    howItWorks:
  ...
  },
  {
    ...
    phMin: null,
    phMax: null,
    description: '고체 형태의 오일 클렌저로, 체온에 녹아 오일처럼 사용돼요.',
  ...
  },
  {
    ...
    phMin: 5.5,
    phMax: 6.5,
    description: '크림처럼 부드러운 질감의 순한 클렌저예요.',
    howItWorks: '순한 계면활성제와 보습 성분이 부드럽게 노폐물을 제거해요.',
    ...
    usage: 'second',
    frequency: 'daily',
    tips: ['아침 클렌저로 적합해요', '화장솜으로 닦아내도 돼요', '민감할 때 사용하기 좋아요'],
  },
  {
    id: 'gel',
    name: 'Gel Cleanser',
    ...
    phMin: 5.0,
    phMax: 6.0,
    description: '투명한 젤 타입으로 깔끔한 세정감을 제공해요.',
  ...
  },
  {
    ...
    phMin: 5.5,
    phMax: 6.5,
    description: '피부 pH와 유사한 약산성으로 피부 장벽을 보호하며 세정해요.',
    howItWorks: '피부와 비슷한 pH로 자극 없이 세정하며 피부 장벽을 유지해요.',
  ...
  },
  {
    ...
    phMin: 8.0,
    phMax: 10.0,
    description: '강력한 세정력으로 피지와 노폐물을 깔끔하게 제거해요.',
    howItWorks: '알칼리성이 피지를 녹여 강력하게 세정하지만, 피부 장벽에 영향을 줄 수 있어요.',
  ...
  },
  {
    ...
    phMin: 5.5,
    phMax: 7.0,
    description: '물처럼 가벼운 타입으로 간편하게 클렌징해요.',
    howItWorks: '미셀라 기술로 노폐물을 끌어당겨 제거해요.',
  ...
  },
  {
    ...
    phMin: 4.5,
    phMax: 5.5,
    description: '파파인, 브로멜라인 등 효소로 각질을 분해하는 클렌저예요.',
    howItWorks: '천연 효소가 죽은 각질 세포의 단백질을 분해하여 부드럽게 제거해요.',
...
export const PH_EXPLANATIONS = {
  acidic: {
    range: '4.5-5.5',
    label: '약산성',
    description: '건강한 피부의 pH와 동일한 범위예요.',
  ...
  alkaline: {
    range: '8.0-10.0',
    label: '약알칼리성',
    description: '강력한 세정력을 제공하지만 피부 장벽에 영향을 줄 수 있어요.',
