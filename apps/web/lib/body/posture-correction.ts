...
export const POSTURE_ISSUES: Record<PostureIssue, PostureIssueDetail> = {
  forward_head: {
    type: 'forward_head',
    name: '거북목 (전방두부자세)',
    description: '머리가 어깨보다 앞으로 나와 있는 자세로, 목과 어깨에 부담을 줘요.',
  ...
  rounded_shoulders: {
    ...
    name: '굽은 어깨 (라운드 숄더)',
    description: '어깨가 앞으로 말린 자세로, 가슴 근육은 짧아지고 등 근육은 늘어나요.',
  ...
  kyphosis: {
    type: 'kyphosis',
    name: '등굽음 (과도한 후만증)',
    description: '등이 과도하게 굽은 상태로, 흔히 "곱추"라고 불려요.',
  ...
  lordosis: {
    type: 'lordosis',
    name: '요추 과전만',
    description: '허리가 과도하게 앞으로 휜 상태예요.',
  ...
  anterior_pelvic_tilt: {
    ...
    name: '골반 전방경사',
    description: '골반이 앞으로 기울어진 상태로, 배가 나와 보여요.',
  ...
  posterior_pelvic_tilt: {
    ...
    name: '골반 후방경사',
    description: '골반이 뒤로 기울어진 상태로, 허리가 평평해 보여요.',
  ...
  scoliosis: {
    type: 'scoliosis',
    name: '척추측만증',
    description: '척추가 옆으로 휜 상태예요. 전문 의료 상담을 권장해요.',
  ...
  flat_back: {
    type: 'flat_back',
    name: '일자허리 (평배)',
    description: '허리의 자연스러운 곡선이 감소한 상태예요.',
  ...
  uneven_shoulders: {
    ...
    name: '어깨 비대칭',
    description: '한쪽 어깨가 다른 쪽보다 높거나 낮은 상태예요.',
  ...
  leg_length_discrepancy: {
    ...
    name: '다리 길이 차이',
    description: '양쪽 다리 길이가 다른 상태로, 실제 또는 기능적 차이일 수 있어요.',
...
export const CORRECTION_EXERCISES: Record<string, CorrectionExercise> = {
  chin_tuck: {
    ...
    description: '거북목 교정의 기본 운동으로, 목 뒤 근육을 강화하고 전방 목 자세를 개선해요.',
    targetArea: '목 뒤 근육',
    duration: '10-15회',
    frequency: '하루 3-4회',
    steps: [
  ...
  neck_stretch: {
    id: 'neck_stretch',
    name: '목 스트레칭',
    description: '긴장된 목 근육을 이완시키는 스트레칭이에요.',
    targetArea: '목 옆면, 승모근',
    duration: '30초씩 양쪽',
    frequency: '하루 2-3회',
    steps: [
      '바른 자세로 앉으세요.',
      '오른손으로 머리 왼쪽을 가볍게 잡아요.',
      '머리를 오른쪽으로 천천히 기울여요.',
      '왼쪽 목에 스트레칭이 느껴지면 30초간 유지해요.',
      '반대쪽도 동일하게 반복해요.',
    ],
    cautions: ['무리하게 당기지 마세요.', '통증이 아닌 당김이 느껴져야 해요.'],
    difficulty: 1,
  },
  chest_stretch: {
    id: 'chest_stretch',
    name: '가슴 스트레칭',
    description: '단축된 가슴 근육을 늘려 어깨 자세를 개선해요.',
    targetArea: '대흉근, 소흉근',
    duration: '30초씩',
    frequency: '하루 3-4회',
    steps: [
  ...
  wall_angel: {
    ...
    description: '등 근육을 활성화하고 어깨 가동성을 개선해요.',
    targetArea: '등 상부, 어깨',
    duration: '10-15회',
    frequency: '하루 2-3회',
    steps: [
  ...
  band_pull_apart: {
    id: 'band_pull_apart',
    name: '밴드 풀 어파트',
    description: '등 상부와 후면 어깨 근육을 강화해요.',
    targetArea: '능형근, 후면 삼각근',
    duration: '15-20회, 3세트',
    frequency: '주 3-4회',
    steps: [
      '탄성 밴드를 양손으로 잡고 팔을 앞으로 뻗으세요.',
      '팔꿈치를 살짝 구부린 상태를 유지해요.',
      '어깨뼈를 모으듯이 밴드를 옆으로 벌려요.',
      '천천히 원래 자세로 돌아와요.',
    ],
  ...
  cat_cow: {
    id: 'cat_cow',
    name: '고양이-낙타 자세',
    description: '척추 유연성을 높이고 등 근육을 이완시켜요.',
    targetArea: '전체 척추',
    duration: '10-15회',
    frequency: '하루 2-3회',
    steps: [
      '네발기기 자세를 취하세요.',
      '숨을 내쉬며 등을 천장으로 둥글게 말아 올려요 (고양이).',
      '숨을 마시며 배를 바닥으로 내리고 고개를 들어요 (낙타).',
      '호흡에 맞춰 천천히 반복해요.',
    ],
  ...
  thoracic_extension: {
    ...
    name: '흉추 신전 스트레칭',
    description: '등 상부의 가동성을 높이고 굽은 등을 개선해요.',
    targetArea: '흉추',
    duration: '30초, 5-10회',
    frequency: '하루 2-3회',
    steps: [
      '폼롤러 위에 등 상부를 대고 누워요.',
      '손을 머리 뒤로 깍지 끼고 팔꿈치를 모아요.',
      '엉덩이를 들지 않은 상태로 등을 뒤로 젖혀요.',
      '5초간 유지 후 원래 자세로 돌아와요.',
    ],
    cautions: ['허리가 아닌 등 상부에서 움직임이 일어나야 해요.', '목을 보호하세요.'],
    difficulty: 2,
  },
  back_extension: {
    id: 'back_extension',
    name: '백 익스텐션',
    description: '등 근육을 강화하고 자세를 개선해요.',
    targetArea: '척추기립근',
    duration: '10-15회, 3세트',
    frequency: '주 2-3회',
    steps: [
  ...
  pelvic_tilt: {
    id: 'pelvic_tilt',
    name: '골반 기울이기',
    description: '골반 정렬을 교정하고 허리 안정성을 높여요.',
    targetArea: '복근, 허리',
    duration: '10-15회',
    frequency: '하루 2-3회',
    steps: [
      '바닥에 누워 무릎을 구부려요.',
      '배꼽을 척추 쪽으로 당기듯이 허리를 바닥에 붙여요.',
      '5-10초간 유지해요.',
      '천천히 이완해요.',
    ],
  ...
  dead_bug: {
    id: 'dead_bug',
    name: '데드 버그',
    description: '코어 안정성을 높이고 골반 조절 능력을 개선해요.',
    targetArea: '복근, 코어',
    duration: '10회씩 양쪽, 3세트',
    frequency: '주 3-4회',
    steps: [
      '바닥에 누워 팔과 다리를 천장으로 들어 올려요.',
      '허리가 바닥에서 떨어지지 않게 유지하세요.',
      '한쪽 팔과 반대쪽 다리를 천천히 내려요.',
      '원래 자세로 돌아온 후 반대쪽 반복해요.',
    ],
  ...
  hip_flexor_stretch: {
    ...
    name: '장요근 스트레칭',
    description: '단축된 고관절 굴곡근을 이완시켜요.',
    targetArea: '장요근, 대퇴직근',
    duration: '30초씩 양쪽',
    frequency: '하루 2-3회',
    steps: [
      '한쪽 무릎을 바닥에 대고 런지 자세를 취해요.',
      '앞쪽 무릎은 90도를 유지하세요.',
      '엉덩이를 앞으로 밀며 뒤쪽 다리 앞면에 스트레칭을 느껴요.',
      '30초간 유지 후 반대쪽 반복해요.',
    ],
  ...
  glute_bridge: {
    id: 'glute_bridge',
    name: '글루트 브릿지',
    description: '둔근을 강화하고 골반 안정성을 높여요.',
    targetArea: '대둔근, 햄스트링',
    duration: '15-20회, 3세트',
    frequency: '주 3-4회',
    steps: [
      '바닥에 누워 무릎을 구부려요.',
      '발은 엉덩이 너비로 벌리고 바닥에 평평하게 둬요.',
      '엉덩이를 천장으로 들어 올려 무릎-엉덩이-어깨가 일직선이 되게 해요.',
      '엉덩이를 조이며 2초간 유지 후 천천히 내려요.',
    ],
  ...
  side_plank: {
    id: 'side_plank',
    name: '사이드 플랭크',
    description: '측면 코어를 강화하고 척추 안정성을 높여요.',
    targetArea: '복사근, 코어',
    duration: '20-30초씩 양쪽',
    frequency: '주 3-4회',
    steps: [
      '옆으로 누워 팔꿈치를 어깨 아래에 둬요.',
      '엉덩이를 들어 올려 발목-무릎-어깨가 일직선이 되게 해요.',
      '20-30초간 유지해요.',
      '반대쪽도 동일하게 반복해요.',
    ],
  ...
  bird_dog: {
    id: 'bird_dog',
    name: '버드독',
    description: '코어 안정성과 균형을 동시에 훈련해요.',
    targetArea: '코어, 등, 둔근',
    duration: '10회씩 양쪽, 3세트',
    frequency: '주 3-4회',
    steps: [
      '네발기기 자세를 취해요.',
      '한쪽 팔과 반대쪽 다리를 동시에 수평으로 뻗어요.',
      '3초간 유지 후 천천히 내려요.',
      '반대쪽 반복해요.',
    ],
  ...
  cobra_stretch: {
    id: 'cobra_stretch',
    name: '코브라 스트레칭',
    description: '복근을 스트레칭하고 척추 신전을 개선해요.',
    targetArea: '복근, 척추',
  ...
  hip_flexor_activation: {
    ...
    name: '장요근 활성화',
    description: '약해진 고관절 굴곡근을 강화해요.',
    targetArea: '장요근',
    duration: '10-15회씩 양쪽, 3세트',
    frequency: '주 3-4회',
    steps: [
      '의자에 앉거나 바닥에 누워 무릎을 90도로 구부려요.',
      '한쪽 무릎을 가슴 쪽으로 들어 올려요.',
      '손으로 저항을 주며 5초간 버텨요.',
      '천천히 내린 후 반대쪽 반복해요.',
    ],
  ...
  hamstring_stretch: {
    ...
    name: '햄스트링 스트레칭',
    description: '뒤쪽 허벅지 근육을 이완시켜요.',
    targetArea: '햄스트링',
    duration: '30초씩 양쪽',
    frequency: '하루 2-3회',
    steps: [
      '바닥에 누워 한쪽 다리를 들어 올려요.',
      '수건이나 밴드로 발을 잡아요.',
      '무릎을 가능한 펴며 당겨요.',
      '뒤쪽 허벅지에 스트레칭이 느껴지면 30초 유지해요.',
    ],
    cautions: ['무릎을 완전히 펴지 못해도 괜찮아요.', '무리하게 당기지 마세요.'],
    difficulty: 1,
  },
  lumbar_extension: {
    id: 'lumbar_extension',
    name: '요추 신전 운동',
    description: '허리의 자연스러운 곡선을 회복해요.',
    targetArea: '요추',
    duration: '10-15회',
    frequency: '하루 2-3회',
    steps: [
      '바닥에 엎드려 누워요.',
      '팔꿈치를 바닥에 대고 상체를 살짝 들어 올려요.',
      '편안한 범위에서 10-15초 유지해요.',
      '천천히 내려와요.',
    ],
  ...
  shoulder_shrug: {
    id: 'shoulder_shrug',
    name: '어깨 으쓱하기',
    description: '어깨 근육의 긴장을 풀고 균형을 잡아요.',
    targetArea: '승모근',
    duration: '10-15회',
    frequency: '하루 3-4회',
    steps: [
  ...
  side_stretch: {
    id: 'side_stretch',
    name: '옆구리 스트레칭',
    description: '측면 근육을 이완시키고 비대칭을 개선해요.',
    targetArea: '측면 몸통',
    duration: '30초씩 양쪽',
    frequency: '하루 2-3회',
    steps: [
  ...
  piriformis_stretch: {
    ...
    name: '이상근 스트레칭',
    description: '엉덩이 깊은 곳의 이상근을 이완시켜요.',
    targetArea: '이상근',
    duration: '30초씩 양쪽',
    frequency: '하루 2-3회',
    steps: [
      '바닥에 누워 무릎을 구부려요.',
      '한쪽 발목을 반대쪽 무릎 위에 올려요.',
      '아래쪽 다리를 양손으로 당겨 가슴 쪽으로 끌어당겨요.',
      '엉덩이 깊은 곳에 스트레칭이 느껴지면 30초 유지해요.',
    ],
...
const DAILY_TIPS: Record<BodyShape7, string[]> = {
  ...
  hourglass: ['코어 운동으로 허리를 보호하세요.', '높은 굽보다 편한 신발을 권장해요.'],
  oval: ['규칙적인 유산소 운동을 권장해요.', '장시간 앉아 있을 때 자주 일어나 스트레칭하세요.'],
...
export function getExercisesForIssue(issue: PostureIssue): CorrectionExercise[] {
  ...
  return issueDetail.recommendedExerciseIds.map((id) => CORRECTION_EXERCISES[id]).filter(Boolean);
}
