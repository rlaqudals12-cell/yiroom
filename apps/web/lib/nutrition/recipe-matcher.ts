...
export const SAMPLE_RECIPES: Recipe[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      '팬에 기름을 두르고 다진 대파와 당근을 볶아요.',
      '밥을 넣고 센 불에서 빠르게 볶아요.',
      '간장과 소금으로 간을 하고 스크램블 계란을 넣어 섞어요.',
    ],
  ...
  },
  {
    ...
    steps: [
      '두부를 1.5cm 두께로 썰어 물기를 제거해요.',
      '팬에 기름을 두르고 두부를 노릇하게 구워요.',
      '양파와 버섯을 넣고 함께 볶아요.',
      '간장 소스를 뿌려 완성해요.',
    ],
  ...
  },
  {
    ...
    steps: [
      '오트밀, 프로틴 파우더, 땅콩버터, 꿀을 섞어요.',
      '반죽이 되직해지면 우유를 조금씩 넣어 농도를 조절해요.',
      '작은 공 모양으로 빚어줍니다.',
      '냉장고에서 30분 이상 굳힙니다.',
    ],
