...
interface MultiAngleSkinCaptureProps {
  /** 촬영 완료 핸들러 */
...
export default function MultiAngleSkinCapture({
  onComplete,
  onCancel,
}: MultiAngleSkinCaptureProps) {
  ...
  const handleValidate = useCallback(
    async (imageBase64: string, expectedAngle: FaceAngle): Promise<ValidateFaceImageResponse> => {
      ...
      try {
        ...
        console.error('[MultiAngleSkinCapture] Validation error:', error);
  ...
  return (
    <div className="relative min-h-[500px]" data-testid="multi-angle-skin-capture">
      <MultiAngleCapture
