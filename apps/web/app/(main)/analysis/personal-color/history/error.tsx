...
export default function PersonalColorHistoryError({ error, reset }: ErrorProps): React.JSX.Element {
  useEffect(() => {
  ...
  return (
    <div
      ...
      data-testid="personal-color-history-error-page"
    >
      <div className="max-w-lg mx-auto px-4 py-8">
        <div className="text-center py-16">
          ...
          <p className="text-muted-foreground mb-6">
            퍼스널 컬러 분석 기록을 불러오는 중 오류가 발생했어요
          </p>
