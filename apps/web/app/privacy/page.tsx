    ...
    <div className="min-h-screen bg-background">
      <div className="mx-auto max-w-3xl px-4 py-12">
        ...
        <div className="prose prose-gray dark:prose-invert max-w-none">
          <p className="text-muted-foreground">최종 업데이트: 2026년 1월 8일</p>

          <section className="mt-8">
            <h2 className="text-xl font-semibold mb-4">1. 개인정보의 처리 목적</h2>
            <p>
              이룸(이하 &quot;회사&quot;)은 다음의 목적을 위하여 개인정보를 처리합니다. 처리하고
          ...
          <section className="mt-8">
            ...
            <ul className="list-disc pl-6 mt-2 space-y-2">
              ...
              <li>
                <strong>서비스 이용 시 수집:</strong> 얼굴/체형 이미지, 운동 기록, 식단 기록, AI
                코치 대화 내용
              </li>
              <li>
              ...
              <li>
                <strong>자동 수집:</strong> 서비스 이용 기록, 접속 로그, 기기 정보, 제휴 링크 클릭
                기록
              </li>
            </ul>
          </section>
          ...
          <section className="mt-8">
            ...
            <p>
              회사는 개인정보보호법 제23조에 따라 사용자의 얼굴, 체형 등 생체정보를 수집·이용하는
              경우 별도의 동의를 받습니다.
            </p>
            <ul className="list-disc pl-6 mt-2 space-y-2">
              <li>
            ...
            <div className="mt-4 p-4 bg-amber-50 dark:bg-amber-950/30 border border-amber-200 dark:border-amber-800 rounded-lg">
              <p className="text-sm text-amber-700 dark:text-amber-300">
                <strong>안내:</strong> 이미지 저장에 동의하지 않아도 분석 서비스는 이용 가능합니다.
          ...
          <section className="mt-8">
            ...
            <div className="mt-4 p-4 bg-muted rounded-lg">
              ...
              <p className="mt-2 text-sm">
                서비스 내 제품 추천 링크를 통해 외부 쇼핑몰(쿠팡 등)로 이동하는 경우, 해당 외부
                서비스의 개인정보처리방침이 적용됩니다. 이룸은 제휴 링크 클릭 여부만 익명으로
                집계하며, 외부 서비스에서의 구매 정보는 수집하지 않습니다.
              </p>
            </div>
          </section>
