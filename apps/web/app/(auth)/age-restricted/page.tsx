  ...
  return (
    ...
    >
      <div className="max-w-md w-full text-center space-y-6">
        ...
        {/* 제목 */}
        <h1 className="text-2xl font-bold text-foreground">서비스 이용이 제한됩니다</h1>

        {/* 설명 */}
        <div className="space-y-3 text-muted-foreground">
          <p>
            이룸은 <strong className="text-foreground">만 {MINIMUM_AGE}세 이상</strong>만 이용할 수
            있습니다.
          </p>
          <p className="text-sm">
            한국 청소년보호법에 따라 만 14세 미만 아동의 개인정보 수집이 제한되어 있습니다.
          </p>
        </div>
        ...
        <div className="bg-amber-50 dark:bg-amber-950/30 border border-amber-200 dark:border-amber-800 rounded-xl p-4 text-left">
          <p className="text-sm text-amber-800 dark:text-amber-300">
            ...
            <br />만 14세 미만 아동의 개인정보 수집을 위해서는 법정대리인의 동의가 필요합니다. 현재
            이룸은 법정대리인 동의 기능을 제공하지 않습니다.
          </p>
        </div>
