    ...
    <Card data-testid="my-rank-card">
      ...
      <CardContent>
        <div className="grid grid-cols-3 gap-4 text-center">
          ...
          {/* 점수 */}
          <div>
            <div className="text-2xl font-bold">{formatScore(ranking.score, ranking.category)}</div>
        ...
        <div className="mt-4 space-y-1">
          ...
          <div className="flex justify-between text-xs text-muted-foreground">
            <span>0%</span>
            <span className="text-primary font-medium">{ranking.percentile.toFixed(1)}%</span>
            <span>100%</span>
          </div>
        </div>
      </CardContent>
