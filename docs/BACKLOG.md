...
### 1.1 ~~Gemini 3 Pro 업그레이드~~ → ✅ Gemini 3 Flash 마이그레이션 완료

| 항목       | 내용                                                       |
| ---------- | ---------------------------------------------------------- |
| **이전**   | gemini-2.5-pro-preview-06-05 (6/17 폐기 예정)              |
| **현재**   | gemini-3-flash-preview (Pro급 성능 + Flash 가격)           |
| **완료일** | 2026-03-12                                                 |
| **비고**   | Pro 업그레이드는 MAU 확보 후 분석 품질 개선 필요 시 재검토 |
...
| 항목                        | 상태    | 보류 사유                  |
| --------------------------- | ------- | -------------------------- |
| 사진 기반 오버레이 (정밀판) | ⏳ 보류 | MediaPipe 통합 필요        |
| ~~Before/After 비교~~       | ✅ 완료 | §2.2 참조 (415줄 + 테스트) |

### 5.3 Launch 준비

| 항목                   | 상태    | 보류 사유                                         |
| ---------------------- | ------- | ------------------------------------------------- |
| ~~브랜딩 로고 최종화~~ | ✅ 완료 | logo.png/svg, favicon, PWA icons (192~512px) 존재 |
...
### ~~11.1 홈 리디자인 (3-State)~~ ✅ 완료

| 항목          | 내용                                                              |
| ------------- | ----------------------------------------------------------------- |
| **현재**      | ✅ 3-State (New/Growing/Active) + WS-1 홈 5블록 축소 완료         |
| **구현**      | HomeStateNew/Growing/Active, ActiveInsightCard, HomeActivityBar   |
| **WS-1**      | InternalizationWidget → HomeActivityBar 4-status 세그먼트 바 통합 |
...
| 버전 | 날짜       | 변경 내용                                                                              |
| ---- | ---------- | -------------------------------------------------------------------------------------- |
| 3.1  | 2026-03-10 | 브랜딩 로고 완료 표시, 홈 리디자인 완료, B/A 비교 상태 동기화, ADR-084 성별 중립화     |
