...
| 문서                                             | 역할                                | 우선순위                             |
| ------------------------------------------------ | ----------------------------------- | ------------------------------------ |
| [**yiroom-philosophy.md**](yiroom-philosophy.md) | 이룸의 모든 설계 판단의 최상위 기준 | **최우선** — 모든 원리 문서보다 우선 |

> 다른 원리 문서와 충돌 시 yiroom-philosophy.md가 우선한다.
...
| [mobile-localization.md](mobile-localization.md)               | 모바일 로컬라이제이션 (공개 언어 게이트·정본 투영) | ADR-122, i18next, expo-localization          | **1.0 (신규)**   |
...
├── oral-health.md           # 구강 건강 — [SUPERSEDED, ADR-098]
...
| 5.0  | 2026-09-07 | mobile-localization.md 신규 추가 (ADR-122 모바일 i18n 런타임 — 번역 배치)                                                         |
