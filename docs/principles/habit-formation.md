...
> **상위 철학**: [yiroom-philosophy.md](./yiroom-philosophy.md) — 이 문서의 모든 설계는 "이해 기반 자립" 철학에 종속된다.
...
```
"이해 기반으로 정착된 일일 웰니스 루틴"

- 사용자가 아침에 궁금해서 앱을 열고 '오늘의 캡슐'을 확인한다
- 추천과 함께 "왜 이 조합인지" 1줄 이유가 표시되어 이해하며 수락한다
- 사용 데이터가 축적될수록 자기 이해가 깊어져 성장 가치가 증가한다
- DAU 70%+ 사용자가 '이해와 궁금함'으로 앱을 사용한다
- 외부 트리거(푸시) 없이도 내적 동기(자기 이해 욕구)로 앱을 열게 된다
```
...
- Hook Model 4단계 사이클 설계 (보상 = 이해의 기쁨)
...
1. Rewards of the Tribe (사회적 보상)
   → 타인과의 연결, 소속감, 인정
   → 이룸: "같은 고민 사용자 커뮤니티", 경험 공유 (비교 순위 금지)
...
│      └── Tribe: "3개월 전 나보다 +8점 성장!" (자기 변화)                │
│                           │                                             │
│                           ▼                                             │
│   ④ Investment: 이해 축적 → 자기 이해 심화                            │
│      ├── 연결 발견 축적 → "A라서 B" 패턴 내재화                        │
│      ├── 히스토리 축적 → "나의 변화 기록" 형성                          │
│      ├── 이해 깊어짐 → 성장 가치 증가 (자발적 재방문 동기)             │
│      └── 다음 트리거 준비: "내일은 어떤 연결을 발견할까?"              │
│                                                                          │
└─────────────────────────────────────────────────────────────────────────┘
```
...
| **Tribe** (사회) | 자기 변화 추적    | 과거 나 vs 현재 나     | 주 1회   |
| **Tribe** (사회) | 친구 활동 알림    | 친구 분석 완료         | 비정기   |

### 3.4 Investment 전략 (성장 가치 설계)
...
핵심: 사용 기간이 길어질수록 "나에 대한 이해"가 깊어져
      자발적으로 돌아오고 싶은 가치가 커진다.
```
...
| 투자 항목        | 축적 방식      | 축적된 가치             |
| ---------------- | -------------- | ----------------------- |
| 자기 변화 기록   | 매일/매주 분석 | 장기 성장 추이 이해     |
| 연결 패턴 내재화 | "A라서 B" 발견 | 자립적 판단력 성장      |
| 웰니스 프로필    | 분석 결과 통합 | 통합된 자기 이해        |
| 이해 깊이        | 꾸준한 학습    | 도메인 판단력           |
| 선호 패턴 이해   | 매일 캡슐 확인 | "왜 이게 나에게 맞는지" |
...
├── 이해 기반 습관: "궁금해서" 앱 오픈 (이해 욕구가 트리거)
├── 장기 Investment: "6개월간의 자기 이해 여정"
└── 유지 보상: 성장 리포트, 자립적 판단 빈도 추적
```
...
**Version**: 2.0 | **Created**: 2026-03-03 | **Updated**: 2026-03-07 | 이해 기반 자립 철학 정렬
