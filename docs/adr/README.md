...
| [ADR-113](./ADR-113-visual-expression-layer.md)                   | 표현 레이어 분리 — AI 자연보정·FASHN 가상착장, 분석 파이프라인 역류 금지·AI 라벨 상시·예측 이미지 미도입                          | accepted | 2026-07-09 |
| [ADR-114](./ADR-114-beauty-team-ia.md)                            | 전속 뷰티팀 IA — 가입=첫 미팅·브리핑 홈(화법 4요소+정직성 가드)·5탭 단일 내비(물어보기 승격)                                      | accepted | 2026-07-10 |
| [ADR-115](./ADR-115-ai-twin.md)                                   | AI 트윈 — 나노바나나 캐싱·"이게 나 맞나요" 승인 게이트·체형 실측 주입·레이어 순차 결합 (ADR-113 상속)                             | accepted | 2026-07-10 |
| [ADR-116](./ADR-116-personal-contrast.md)                         | 퍼스널 대비 실측 — 모발-피부 L\* 격차(시즌과 직교), 추측 contrastLevel 제거·신뢰도 미달 시 미판정                                 | accepted | 2026-07-10 |
| [ADR-117](./ADR-117-custom-routine-engine.md)                     | 맞춤 루틴 엔진 v1 — 내 화장대 shelf-우선 배치·빈 슬롯=구매 연결·concerns 정본화·'처방' 용어 금지                                  | accepted | 2026-07-10 |
...
| [ADR-122](./ADR-122-mobile-i18n-runtime.md)                       | 모바일 i18n 런타임 — expo-localization + i18next/react-i18next, 한국어 정본·화면별 점진 전환·공개 locale 게이트                   | accepted | 2026-09-05 |
...
- ADR-118: 모바일 패리티 공유 방식 — 웹 API 정본 + thin client (2026-07-10)

### 확장성 (Scalability)

- ADR-018: 국제화(i18n) 아키텍처
- ADR-122: 모바일 i18n 런타임과 점진 전환 (2026-09-05)
- ADR-074: 캡슐 확장성 전략
...
- ADR-119: 법적 컴플라이언스 게이트 — 생체동의(BIPA)·연령·위치·파기·고지·AI 라벨 (2026-07-12)
...
- ADR-120: 에디토리얼 공유·랜딩 디자인 시스템 — 무점수 진단지·크림 고정 지면 (2026-07-18)
- ADR-121: 프리런치 제품 결정 6건 — 소셜/성별/남성/신뢰문구/미성년/문진 (2026-08-31)
