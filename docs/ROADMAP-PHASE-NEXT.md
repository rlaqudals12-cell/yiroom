...
# Phase K: 종합 업그레이드 📋 계획 중
# 스펙 문서: docs/specs/SDD-PHASE-K-COMPREHENSIVE-UPGRADE.md
[ ] K-1: 성별 중립화 (온보딩, 남성 추천)
[ ] K-2: 패션 확장 (스타일 카테고리, Best 10, 사이즈 추천)
[ ] K-3: 체형 분석 강화 (키/몸무게, BMI, 자세 교정)
[ ] K-4: 영양/레시피 확장 (인벤토리, 레시피 추천)
[ ] K-5: 관리자/프로필 리디자인
```
