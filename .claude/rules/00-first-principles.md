...
> 궁극의 형태 문서 템플릿 → [principles-guide.md](./principles-guide.md)
...
> 원자 정의 템플릿 → [principles-guide.md](./principles-guide.md)
...
> CIE-1(이미지 품질 검증) 워크드 예시 → [principles-guide.md](./principles-guide.md)
...
**Version**: 3.1 | **Priority**: 최우선 (P0)
**Created**: 2026-01-15 | **Updated**: 2026-07-12
**Applies to**: 모든 작업, 예외 없음
**변경 이력**: v3.1 - 템플릿·적용예시를 principles-guide.md로 이관 (원칙 본문 불변) | v3.0 - P8 (모듈 경계) 추가, G7 Gate 추가 | v2.0 - P7 추가
