...
| 카테고리                      | 파일 수 | 설명                        |
| ----------------------------- | ------- | --------------------------- |
| [제1원칙](#1-제1원칙-최우선)  | 1개     | 모든 규칙의 기반            |
| [코드 스타일](#2-코드-스타일) | 4개     | 코딩 표준, 패턴             |
| [프레임워크](#3-프레임워크)   | 3개     | Next.js, React, Mobile      |
| [데이터](#4-데이터)           | 3개     | Supabase, API, 마이그레이션 |
| [AI/ML](#5-aiml)              | 3개     | AI 통합, 프롬프트, Hybrid   |
| [품질](#6-품질)               | 3개     | 테스트, 보안, 성능          |
| [운영](#7-운영)               | 2개     | Git, Feature Flags          |
...
| [performance-guidelines.md](./performance-guidelines.md) | Core Web Vitals, 번들 최적화  | P5: 속도  |
...
| [git-workflow.md](./git-workflow.md)             | 브랜치, 커밋, PR 규칙            | P7        |
...
| 파일                                   | 용도                              | 관련 원칙 |
| -------------------------------------- | --------------------------------- | --------- |
| [git-workflow.md](./git-workflow.md)   | 브랜치 전략, Conventional Commits | P6        |
| [feature-flags.md](./feature-flags.md) | 피처 플래그, 롤아웃 전략          | P5, P6    |
...
| 원칙                  | 관련 규칙 파일                                                                                      |
| --------------------- | --------------------------------------------------------------------------------------------------- |
| **P0: 요구사항 의심** | security-checklist.md                                                                               |
...
| **P3: 원자 분해**     | testing-patterns.md, react-patterns.md, api-design.md, db-migration-rules.md                        |
| **P4: 단순화**        | code-style.md, error-handling-patterns.md, hybrid-data-pattern.md                                   |
| **P5: 속도**          | performance-guidelines.md, feature-flags.md                                                         |
| **P6: 자동화**        | git-workflow.md, feature-flags.md                                                                   |
| **P7: 워크플로우**    | principles-guide.md, db-migration-rules.md, git-workflow.md                                         |
| **P8: 모듈 경계**     | encapsulation.md                                                                                    |
